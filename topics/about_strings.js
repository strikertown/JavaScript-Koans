...
test("delimiters", function() {
    ...
    equal(singleQuotedString === doubleQuotedString, true, 'are the two strings equal?');
});
...
test("escape character", function() {
    ...
    equal(stringWithAnEscapedCharacter, 'Apple', 'what  is the value of stringWithAnEscapedCharacter?');
});
